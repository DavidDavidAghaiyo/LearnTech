...
//Function to create messag elements
...
//Function to allow auto scrolling
...
const generateResponse = async (botMsgDiv) => {
  ...
  // Add user messages and file data to the chat history
  chatHistory.push({
    role: "user",
    parts: [
...
fileInput.addEventListener("change", () => {
  ...
  reader.onload = (e) => {
    ...
    // Storing file data in userData obj
    userData.file = {
      fileName: file.name,
      data: base64String,
      mime_type: file.type,
